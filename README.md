...
### 简介
该项目是基于dragonir的h5-scan-qrcode项目的核酸检测统计小应用，主要用于记录公司/企业园区员工今日有无做核酸，并自动统计结果（导出Excel文件），方便公司/企业园区管理人员及时告知。(程序本身不会采集任何用户信息，用户信息的导入/导出完全掌握在使用者手中，保证了隐私安全。该程序仅供内部使用！！)

https://catkevin.github.io/h5-scan-qrcode/#/
